...
public class SmartCameraTest 
{
    ...
    public void testConstructor()
    {
        ...
        smartCam = new SmartCamera("cam",false,LocalDateTime.of(2022,3,25,15,45),LocalDateTime.of(2022,3,25,15,45),"(1 2 3)",3,4.5);
        assertNotNull(smartCam);
    ...
    {
        SmartCamera smartCam = new SmartCamera("cam",false,LocalDateTime.of(2022,3,25,15,45),LocalDateTime.of(2022,3,25,15,45),"(1 2 3)",3,4.5);
        assertEquals(3, smartCam.getResolucao());
        smartCam = new SmartCamera("cam",false,LocalDateTime.of(2022,3,25,15,45),LocalDateTime.of(2022,3,25,15,45),"(1 2 3)",3,4.5);
        assertEquals("(1 2 3)", smartCam.getResolucao());
    ...
    {
        SmartCamera cam = new SmartCamera("cam",false,LocalDateTime.of(2022,3,25,15,45),LocalDateTime.of(2022,3,25,15,45),"(1 2 3)",3,4.5);
        cam.setResolucao("(2 4 5)");
        assertEquals("(2 4 5)", cam.getResolucao());
    }
    ...
    {
        SmartCamera cam = new SmartCamera("cam",true,LocalDateTime.of(2022,3,25,15,45),LocalDateTime.of(2022,3,25,15,45),"(1 2 3)",3,4.5);
        cam.turnCameraOff();
    ...
    public void testToString()
    {
        ...
        cam = new SmartCamera("cam",true,LocalDateTime.of(2022,3,25,15,45),LocalDateTime.of(2022,3,25,15,45),"(1 2 3)",3,4.5);
    ...
    {
        SmartCamera cam = new SmartCamera("cam",true,LocalDateTime.of(2022,3,25,15,45),LocalDateTime.of(2022,3,25,15,45),"(1 2 3)",3,4.5);
        SmartCamera cam2 = new SmartCamera("cam2",true,LocalDateTime.of(2022,3,25,15,45),LocalDateTime.of(2022,3,25,15,45),"(1 2 3)",3,4.5);
